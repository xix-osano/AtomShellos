        ...
        Column {
            ...
            StyledRect {
                ...
                Column {
                    ...
                    Column {
                        ...
                        StyledText {
                            text: "Controls opacity of the DankBar panel background"
                    ...
                    Column {
                        ...
                        Item {
                            ...
                            Column {
                                ...
                                StyledText {
                                    text: "Controls opacity of individual widgets inside DankBar"
                                    font.pixelSize: Theme.fontSizeSmall - 2
                                    color: Theme.surfaceVariantText
                                    width: parent.width
                                    wrapMode: Text.WordWrap
                    ...
                    Column {
                        ...
                        StyledText {
                            text: "Controls opacity of all popouts, modals, and their content layers (DankDash, Settings, App Drawer, Control Center, etc.)"
                            font.pixelSize: Theme.fontSizeSmall - 2
                            color: Theme.surfaceVariantText
                            width: parent.width
                            wrapMode: Text.WordWrap
                    ...
                    Row {
                        ...
                        Column {
                            ...
                            StyledText {
                                text: "Show darkened overlay behind modal dialogs"
                                font.pixelSize: Theme.fontSizeSmall
                                color: Theme.surfaceVariantText
                            }
                        }
            ...
            StyledRect {
                ...
                Column {
                    ...
                    StyledText {
                        text: `Generate baseline GTK3/4 or QT5/QT6 (requires qt6ct-kde) configurations to follow DMS colors. Only needed once.<br /><br />It is recommended to configure <a href="https://github.com/xix-osano/AtomShellos/blob/master/README.md#Theming" style="text-decoration:none; color:${Theme.primary};">adw-gtk3</a> prior to applying GTK themes.`
