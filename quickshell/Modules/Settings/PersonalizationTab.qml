                    ...
                    Column {
                        ...
                        Column {
                            ...
                            DankDropdown {
                                ...
                                text: "Matugen Target Monitor"
                                description: "Monitor whose wallpaper drives dynamic theming colors"
                                currentValue: {
                ...
                Column {
                    ...
                    Row {
                        ...
                        Column {
                            ...
                            StyledText {
                                text: "Enable compositor-targetable blur layer (namespace: dms:blurwallpaper). Requires manual niri configuration."
                                font.pixelSize: Theme.fontSizeSmall
                                color: Theme.surfaceVariantText
                                wrapMode: Text.WordWrap
                                width: parent.width
