            ...
            StyledRect {
                ...
                Column {
                    ...
                    DankToggle {
                        ...
                        width: parent.width
                        text: "Night Mode"
                        description: DisplayService.gammaControlAvailable ? "Apply warm color temperature to reduce eye strain. Use automation settings below to control when it activates." : "Gamma control not available. Requires DMS API v6+."
