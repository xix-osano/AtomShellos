...
Singleton {
    ...
    readonly property string stateDir: Paths.strip(StandardPaths.writableLocation(StandardPaths.GenericCacheLocation).toString()) + "/AtomShellos"

    readonly property bool envDisableMatugen: Quickshell.env("ASH_DISABLE_MATUGEN") === "1" || Quickshell.env("ASH_DISABLE_MATUGEN") === "true"
    ...
    readonly property var availableMatugenSchemes: [({
                                                    ...
                                                    ({
                                                        ...
                                                        "description": "High-contrast palette for strong visual distinction."
                                                    }),
                                                    ({
