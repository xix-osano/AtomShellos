...
The `PopoutService` singleton provides plugins with access to all AtomShellos popouts and modals. It's automatically injected into plugin widgets and daemons, enabling them to control shell UI elements.
