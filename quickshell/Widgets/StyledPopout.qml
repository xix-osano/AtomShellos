...
PanelWindow {
    ...
    property string layerNamespace: "ash:popout"
    ...
    readonly property real alignedX: Theme.snap((() => {
        if (SettingsData.barPosition === SettingsData.Position.Left) {
            return triggerY + SettingsData.barBottomGap
        } else if (SettingsData.barPosition === SettingsData.Position.Right) {
            return screenWidth - triggerY - SettingsData.barBottomGap - popupWidth
        } else {
    ...
    Item {
        ...
        readonly property bool barTop: SettingsData.barPosition === SettingsData.Position.Top
        readonly property bool barBottom: SettingsData.barPosition === SettingsData.Position.Bottom
        readonly property bool barLeft: SettingsData.barPosition === SettingsData.Position.Left
        readonly property bool barRight: SettingsData.barPosition === SettingsData.Position.Right
