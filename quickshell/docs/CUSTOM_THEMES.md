...
This guide covers creating custom themes for AtomShellos. You can define your own color schemes by creating theme files that the shell can load.
...
You can also edit `~/.config/AtomShellos/settings.json` manually
